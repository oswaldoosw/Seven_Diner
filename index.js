...
const {StaffSearchMenuItemController} = require("./controller/Staff/StaffSearchMenuItemController.js")
...
const {CustomerViewOrderController} = require("./controller/Customer/CustomerViewOrderController.js");
...
let staffSearchMenuItemController = new StaffSearchMenuItemController();
...
let customerViewOrderController = new CustomerViewOrderController();
...
app.get('/', loginUIBoundary.DisplayCustomer);
app.get('/Login', loginUIBoundary.DisplayLogin);
...
app.post('/StaffSearchMenuItemController', staffSearchMenuItemController.SearchMenuItem);
...
app.get('/Customer/CustomerViewOrder', loginUIBoundary.DisplayCustomerViewOrder);
...
app.post('/CustomerViewOrderController', customerViewOrderController.ViewOrder);

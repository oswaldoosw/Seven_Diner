...
const {DeleteCurrentOrderController} = require("../controller/DeleteCurrentOrderController.js");
...
class LoginPostUI  {
    ...
    DisplayCustomerViewOrder(req, res) {
        var path = require('path');
        var filePath = "./boundary/Customer/CustomerViewOrderUI.ejs"
        var resolvedPath = path.resolve(filePath);
        console.log("resolvedPath: " + resolvedPath);
        res.render(resolvedPath, {menuItemData : "", pricing : 0});
